<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSupplierDetails.aspx.cs" Inherits="OnlineShopping.AdminSupplierDetails" %>
        ...
        <div class="main-container cart-holder">
            <div class="main-content container">
                ...
                <div class="tabs-holder">
                    ...
                    <asp:LinkButton ID="lbtnSupplierDetails" class="tab active" runat="server" OnClick="lbtnSupplierDetails_Click">Supplier Details</asp:LinkButton>
                ...
                <div class="search-filter-block d-flex align-items-center">
                    ...
                    <div class="search mr-5 w-50">
                        <div class="form-group mb-0 d-flex px-5">
                            <button runat="server" id="btnRun" onserverclick="btnAddSupplier" class="btn-pro btn-primary">
                ...
                <div class="cart-product-detials-holder d-flex mx--15">
                    <div class="cart-product-holder w-70 px-15">
                        <asp:GridView ID="grdAdminProductDetails" runat="server"
                            ...
                            HeaderStyle-CssClass="header" RowStyle-CssClass="rows" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="SUPPLIERID" Height="271px" Width="1074px" GridLines="None">
                            <Columns>
                                <asp:TemplateField HeaderText="SUPPLIER ID">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProductId" runat="server" Text='<%# Eval("SUPPLIERID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="SupplierName" HeaderText="SUPPLIER NAME" ReadOnly="true" />
                                <asp:BoundField DataField="SupplierGroup" HeaderText="GROUP NAME" ReadOnly="true" />
