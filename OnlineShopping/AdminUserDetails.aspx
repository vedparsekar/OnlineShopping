<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUserDetails.aspx.cs" Inherits="OnlineShopping.AdminUserDetails" %>
        ...
        <div class="main-container cart-holder">
            <div class="main-content container">
                ...
                <div class="tabs-holder">
                    ...
                    <asp:LinkButton ID="lbtnUserDetails" class="tab active" runat="server" OnClick="lbtnUserDetails_Click">User Details</asp:LinkButton>
                ...
                <div class="cart-product-detials-holder d-flex mx--15">
                    <div class="cart-product-holder w-70 px-15">
                        <asp:GridView ID="grdAdminProductDetails" runat="server"
                            ...
                            HeaderStyle-CssClass="header" RowStyle-CssClass="rows" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnSelectedIndexChanged="grdCartDetails_PageIndexChanging" DataKeyNames="USERID" Height="271px" Width="1074px" GridLines="None">
                            <Columns>
                               <%-- <asp:TemplateField HeaderText="PRODUCT ID">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProductId" runat="server" Text='<%# Eval("USERID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
